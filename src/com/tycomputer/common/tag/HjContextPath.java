...
public class HjContextPath extends MySimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		sb.append("<meta name='Description' Content=").append(Constants.hjdescription).append("'>");
		sb.append("<meta name='keywords' content='").append(Constants.hjkeywords).append("'>");
		...
		sb.append("<link href='ico.ico' rel=\"SHORTCUT ICON\">");
...
//		sb.append("<script>document.observe('dom:loaded', function() {new Carousel('carousel-wrapper', $$('#carousel-content .slide'),null,{auto:true,circular:true,frequency:5});});</script>\n");
		...
		sb.append("<script>document.observe('dom:loaded',function(){new Ferdinand.Slider('slider-demo',{url:'js/hj.json'});});</script>");
