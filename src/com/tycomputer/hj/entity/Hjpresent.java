...
public class Hjpresent  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Hjpresent(String uid, Hjdatacata datacata, Hjdatatype datatype, String pname, Double price, String flag, Calendar addData) {
        this.uid = uid;
    ...
    /** full constructor */
    public Hjpresent(String uid, Hjdatacata datacata, Hjdatatype datatype, String pname, Double price, Double inprice, String description, String litpic, String bigpic, String unit, String spec, Integer buynum, String itsize, String packsize, String weight, String material, String words, Integer ordersn, String note, String factory, String flag, Calendar addData) {
        this.uid = uid;
        this.datacata = datacata;
        this.datatype = datatype;
        this.pname = pname;
	...
	public Hjdatatype getDatatype() {
		return datatype;
	}

	public void setDatatype(Hjdatatype datatype) {
		this.datatype = datatype;
	}
