...
<table class="tylistWidth" border="0" align="center" cellpadding="0" cellspacing="0" class="listWidth" style="border-bottom: 1px solid #9c9c9c">
	<tr>
		<td height="21" class="a STYLE39">
			<table width="100%">
				<tr>
					<td width="50%"><span class="a STYLE55">以下礼品的检索条件&nbsp;&nbsp;分类:<span id="tstr" class="spanNum"></span>&nbsp;&nbsp;小类:<span id="dstr" class="spanNum"></span>&nbsp;&nbsp;<span id="pstr" class="spanNum"></span></span></td>
